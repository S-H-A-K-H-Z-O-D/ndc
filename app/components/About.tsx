...
const About = () => {
    ...
    return (
        <div className="px-64 bg-white text-black rounded-[30px] py-16 max-[1450px]:px-12 max-[1040px]:px-3">
            ...
            <p className="text-2xl text-[#525252] mb-6 mt-8 max-[1040px]:text-[14px] max-[1040px]:mt-6 max-[1040px]:mb-4">Над вашим проектом будут работать</p>
